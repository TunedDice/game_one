...
@onready var pause_menu = $Camera2D/pausemenu #without the "_" is a canvaslayer, using it so the menus are scalable with window size
@onready var paused = false
@onready var options_menu_ingame = $Camera2D/settings
